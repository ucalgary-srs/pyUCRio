.PHONY: install update get-test-data build-test-data get-test-data-clean rebuild-test-data docs show-outdated test test-linting test-ruff test-pycodestyle test-bandit test-pyright test-pytest test-notebooks test-coverage tool-checks publish
