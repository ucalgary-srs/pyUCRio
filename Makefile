.PHONY: install update get-test-data test test-linting test-pycodestyle test-bandit test-pytest test-pytest-search test-coverage show-outdated docs publish
