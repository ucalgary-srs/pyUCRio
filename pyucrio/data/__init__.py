...
for data provided by the University of Calgary, such as NORSTAR Riometers, and
SWAN Hyper Spectral Riometers (HSR).
"""
...
class DataManager:
    """
    The DataManager object is initialized within every PyUCRio object. It acts as a way to access 
    the submodules and carry over configuration information in the super class.
    """

    def __init__(self, rio_obj):
        self.__rio_obj = rio_obj

        # initialize sub-modules
        self.__ucalgary = UCalgaryManager(self.__rio_obj)
    ...
    def ucalgary(self):
        """
        Access to the `ucalgary` submodule from within a PyUCRio object.
        """
